...
namespace GuiShopping.IdentityServer.Initializer
{
    public  class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            {
                UserName = "gui-admin",
                Email = "gui-admin@ramos.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 954845784",
                FirstName = "Gui",
                LastName = "Admin"
            };
            _user.CreateAsync(admin, "Gui159!").GetAwaiter().GetResult();
            ...
            {
                UserName = "gui-client",
                Email = "gui-client@ramos.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 954845784",
                FirstName = "Gui",
                LastName = "Client"
            };
            _user.CreateAsync(client, "Gui159!").GetAwaiter().GetResult();
